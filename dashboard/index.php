            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $supplier->getRowSpl(); ?></div>
                    </div>
                    <div class="col-auto">
					    <i class="fa fa-truck fa-2x text-gray-300" aria-hidden="true"></i>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Hi <?= (isset($_SESSION['username']) ? $_SESSION['username'] : 'guys');  ?>. Hope You Enjoy! </h2>
